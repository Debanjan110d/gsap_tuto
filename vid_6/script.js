...
//     //? if we give stagger - value then the animation will start from the end(means opposite direction)
// stagger: -0.05
// });


//! Lets make this more advanced
...
function brokenText() {
    ...
    const middleIndex = Math.floor(h1_splited_text.length / 2);
    ...
    h1.innerHTML = `${firstHalf}${secondHalf}`;
